<template>
	<view>
		...
		<view class="operate_area">
			<uni-list><uni-list-item clickable :show-arrow="true" title="我的派送" @click="view_my_packages" /></uni-list>
		</view>
		<view class="operate_area">
			<uni-list>
		...
		<view class="logout_area"><button type="warn" @click="logout">退出登录</button></view>
	</view>
</template>
