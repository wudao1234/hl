package org.mstudio.modules.quartz.rest;

import lombok.extern.slf4j.Slf4j;
import org.mstudio.aop.log.Log;
import org.mstudio.exception.BadRequestException;
import org.mstudio.modules.quartz.domain.QuartzJob;
import org.mstudio.modules.quartz.domain.QuartzLog;
import org.mstudio.modules.quartz.service.QuartzJobService;
import org.mstudio.modules.quartz.service.query.QuartzJobQueryService;
import org.mstudio.modules.quartz.service.query.QuartzLogQueryService;
...
public class QuartzJobController {
    ...
    @DeleteMapping(value = "/jobLogs")
    @PreAuthorize("hasAnyRole('ADMIN', 'JOB_ALL')")
    public ResponseEntity deleteAllJobLogs(){
        quartzLogQueryService.deleteAll();
