...
import org.mstudio.modules.system.service.mapper.PermissionMapper;
...
public class PermissionServiceImpl implements PermissionService {
    ...
    public void update(Permission resources) {
        ...
        permission.setSort(resources.getSort());
    ...
    public Object getPermissionTree(List<Permission> permissions) {
        ...
        permissions.sort(Comparator.comparingInt(Permission::getSort));
    ...
    public Object buildTree(List<PermissionDTO> permissionDTOS) {
        ...
        permissionDTOS.sort(Comparator.comparingInt(PermissionDTO::getSort));
