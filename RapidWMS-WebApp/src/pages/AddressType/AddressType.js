...
import styles from './AddressType.less';

const FormItem = Form.Item;
const { Search } = Input;

@connect(({ addressType, loading }) => ({
  list: addressType.list.content,
  total: addressType.list.totalElements,
  loading: loading.models.addressType,
}))
@Form.create()
    ...
    const getModalContent = () => {
      ...
      return (
        <Form onSubmit={this.handleSubmit}>
          <FormItem label="种类名称" {...this.formLayout} hasFeedback>
