...
import styles from './WareZone.less';

const FormItem = Form.Item;
const { Search } = Input;

@connect(({ wareZone, loading }) => ({
  list: wareZone.list.content,
  total: wareZone.list.totalElements,
  loading: loading.models.wareZone,
}))
@Form.create()
class WareZone extends PureComponent {
  state = {
    currentPage: 1,
    pageSize: 10,
    orderBy: null,
  ...
  columns = [
    ...
    {
      title: '库位数量',
      dataIndex: 'warePositionCount',
      key: 'warePositionCount',
      width: '8%',
      align: 'right',
      render: text => {
    ...
    const getModalContent = () => {
      ...
      return (
        <Form onSubmit={this.handleSubmit}>
          <FormItem label="库区名称" {...this.formLayout} hasFeedback>
