...
import styles from '../AddressType/AddressType.less';

const FormItem = Form.Item;
const { Search } = Input;

@connect(({ addressArea, loading }) => ({
  list: addressArea.list.content,
  total: addressArea.list.totalElements,
  loading: loading.models.addressArea,
}))
@Form.create()
class addressArea extends PureComponent {
  state = {
    currentPage: 1,
    pageSize: 10,
    orderBy: null,
    ...
    const getModalContent = () => {
      ...
      return (
        <Form onSubmit={this.handleSubmit}>
          <FormItem label="地区名称" {...this.formLayout} hasFeedback>
